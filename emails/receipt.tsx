...
const baseUrl = 'https://online-store-ten-gray.vercel.app'

interface DetailsType {
  order: Partial<OrderType>
}

export const ReceiptEmail = ({ order }: DetailsType) => (
  <Html>
    <Head />
      ...
      <Container style={container}>
        <Section style={track.container}>
          <Row>
            ...
            <Column align="right">
              <Link
                href={`${baseUrl}/trackorder/1ZV218970300071628`}
                style={global.button}
              >
                Track Package
              </Link>
        ...
        <Section style={message}>
          <Heading style={global.heading}>It&apos;s On the Way.</Heading>
        ...
        <Section style={global.defaultPadding}>
          <Row style={{ display: 'inline-flex', marginBottom: 40 }}>
            <Column style={{ width: '170px' }}>
              ...
              <Text style={track.number}>{order.orderId}</Text>
            </Column>
            <Column>
        ...
        <Section style={paddingY}>
          <Row>
            <Text style={global.heading}>Online Store</Text>
          </Row>
        ...
        <Section style={paddingY}>
          ...
          <Row>
            <Text style={footer.text}>
              © 2022 Online Store, Inc. All Rights Reserved.
            </Text>
          </Row>
        </Section>
      </Container>
